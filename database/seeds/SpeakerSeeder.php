...
class SpeakerSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('speakers')->insert([
            ...
            'charla'=>"Emprendimientos de 1 centavo",
            ...
            'url_charla' => "https://youtu.be/dcXMT7nrOh0"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Jazmin Quiroz Calizaya",
            'charla'=>"Los murciélagos: nuestros primos invisibles",
            ...
            'url_charla' => "https://youtu.be/s_d6HFkEvp0"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Carlos Guaipatin",
            'charla'=>"Innovación social: muchas definiciones, un ejemplo",
            ...
            'url_charla' => "https://youtu.be/94URYsTz0P0"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Álex Ayala Ugarte",
            'charla'=>"La vida de las cosas",
            ...
            'url_charla' => "https://youtu.be/MOZ4INiFktM"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Marco Antonio Quelca",
            'charla'=>"La memoria en una cocina contemporánea",
            ...
            'url_charla' => "https://youtu.be/-rwPzK9duAQ"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Jorge López",
            'charla'=>"La economía del saber",
            ...
            'url_charla' => "https://youtu.be/CsSVvSKPdBE"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Carla Maldonado",
            'charla'=>"¿Puede la modernidad científica obviar el conocimiento tradicional?",
            ...
            'url_charla' => "https://youtu.be/a_9bUvkCMu0"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Sergio Caballero",
            'charla'=>"¿Por qué realmente todo es mejor con una cebra?",
            ...
            'url_charla' => "https://youtu.be/zgbn6PUTtHs"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Juan Sebastian Osorio",
            'charla'=>"Soluciones en salud global con colaboración y tecnología",
            ...
            'url_charla' => "https://youtu.be/a-yq8a-tfZU"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Alina Santander Vinokurova",
            'charla'=>"3, 2, 1 ¡despegue! Nos elevamos levantando a otros",
            ...
            'url_charla' => "https://youtu.be/7Ljr5k7GonU"
        ]);
        ...
        DB::table('speakers')->insert([
            ...
            'url_charla' => "https://youtu.be/kKigUgJZ4tM"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Mohammed Mostajo",
            'charla'=>"Repensando el cerebro",
            ...
            'url_charla' => "https://youtu.be/J55SiFqW3nU"
        ]);

        DB::table('speakers')->insert([
            'nombre'=>"Richard Mateos",
            'charla'=>"La discapacidad no existe, existe la diversidad",
            ...
            'url_charla' => "https://youtu.be/MtwK8YBWvvM"
        ]);
    }
}
