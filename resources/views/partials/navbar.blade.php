    ...
    <nav>
        <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down table-of-contents">
                <li class="about"><a href="{{url('about')}}">Acerca de</a></li>
                ...
                <li class="participar" style="background-color:#07c7b9;">
                    <a href="{{url('participar')}}" style="color:white !important">
                    <b>Areas de trabajo</b>
                    </a>
                </li>
            </ul>
